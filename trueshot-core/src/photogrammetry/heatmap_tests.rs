...
mod tests {
    ...
    fn test_density_from_count() {
        assert_eq!(
            CoverageDensity::from_point_count(0, 100),
            CoverageDensity::None
        );
        assert_eq!(
            CoverageDensity::from_point_count(10, 100),
            CoverageDensity::VeryLow
        );
        assert_eq!(
            CoverageDensity::from_point_count(30, 100),
            CoverageDensity::Low
        );
        assert_eq!(
            CoverageDensity::from_point_count(50, 100),
            CoverageDensity::Medium
        );
        assert_eq!(
            CoverageDensity::from_point_count(70, 100),
            CoverageDensity::Good
        );
        assert_eq!(
            CoverageDensity::from_point_count(90, 100),
            CoverageDensity::Excellent
        );
    }
