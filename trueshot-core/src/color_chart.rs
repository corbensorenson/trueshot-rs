...
fn reference_colors() -> Vec<[f32; 3]> {
    vec![
        [0.400, 0.350, 0.260], [0.650, 0.480, 0.350], [0.290, 0.420, 0.690],
        [0.370, 0.580, 0.290], [0.450, 0.270, 0.270], [0.770, 0.650, 0.210],
        [0.180, 0.240, 0.600], [0.310, 0.180, 0.510], [0.680, 0.230, 0.230],
        [0.200, 0.560, 0.570], [0.810, 0.720, 0.230], [0.460, 0.160, 0.440],
        [0.750, 0.330, 0.210], [0.120, 0.120, 0.120], [0.230, 0.230, 0.230],
        [0.350, 0.350, 0.350], [0.480, 0.480, 0.480], [0.620, 0.620, 0.620],
        [0.750, 0.750, 0.750], [0.880, 0.880, 0.880], [0.060, 0.060, 0.060],
        [0.180, 0.070, 0.060], [0.090, 0.090, 0.240], [0.040, 0.160, 0.070],
    ]
}
