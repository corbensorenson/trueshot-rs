    ...
    pub fn standard() -> Self {
        Self {
            ...
            steps: vec![
                ...
                ScanAction::PromptUser {
                    message: "Clear Turntable for Background".to_string(),
                },
                ScanAction::CaptureBackground,
                ScanAction::PromptUser {
                    message: "Place Object".to_string(),
                },
                ScanAction::CheckCentering, // New Safety Check
                ScanAction::Calibrate {
                    quality: QualityLevel::High,
                },
                ScanAction::PromptUser {
                    message: "Flip Object".to_string(),
                },
                ScanAction::SmartScan {
                    quality: QualityLevel::High,
                    capture: CaptureConfig::Auto {
                        quality: QualityLevel::High,
                    },
                },
