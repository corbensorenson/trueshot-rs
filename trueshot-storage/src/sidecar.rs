...
pub fn write_xmp_sidecar(path: &std::path::Path, params: &SidecarParams) -> std::io::Result<()> {
 ...
 <rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about=""
   ...
   <exif:DateTimeOriginal>{}</exif:DateTimeOriginal>
        ...
        params.steppers_pos, params.lighting_state, params.camera_id, params.timestamp
    );
