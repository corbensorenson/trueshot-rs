...
- Status: In Progress (P0 image-quality moat, researched 2026-07-26)
  ...
  - Remaining: calibration capture/fit workflow, empirical uncertainty coverage, held-out physical-depth/pupil/PSF and lens-breathing calibration, real halo-energy/MTF/mixed-pixel qualification, selective local alignment/overlays, glare separation, and adaptive-planner hardware/manifest integration plus real efficiency qualification.
