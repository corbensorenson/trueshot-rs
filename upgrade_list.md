...
- Status: In Progress (2026-07-26)
  ...
  - Remaining: exact multi-pass Metal AHD, retained real integrating-sphere and chart/corpus quality gates across supported optical/thermal configurations, and release-mode Apple hardware baselines.
...
- Status: In Progress (P0 image-quality moat, researched 2026-07-26)
  ...
  - Regenerated OpenAPI with all five adaptive-session routes and revalidated formatting, feature-matrix consistency, 394 passing workspace all-target unit/integration tests plus two passing doctests (five declared tests/doctests ignored), and strict workspace Clippy across all targets on macOS.
  - Remaining: retained real per-ISO Z9 dark/flat/integrating-sphere capture and real-sensor posterior/spatial qualification across focus distance, temperature, and exposure duration; dark-current/temperature, physical-depth/pupil/PSF, lens-breathing, and per-lens/aperture/wavelength glare calibration; real hair/fur/transparency halo-energy/MTF, glossy-glare, and dynamic-motion/disocclusion qualification; interactive source/glare/trimap retouching; calibrated absolute lens-drive/readback, dashboard flow integration, exact Metal AHD qualification, and full-pipeline real-NEF wall-time/RSS/energy/thermal qualification.
