...
- Status: In Progress (P0 image-quality moat, researched 2026-07-26)
  ...
  - Remaining: retained real per-ISO Z9 dark/flat capture and real-sensor posterior qualification; lens shading, defect, dark-current/temperature, physical-depth/pupil/PSF, lens-breathing, and per-lens/aperture/wavelength glare calibration; real halo-energy/MTF/mixed-pixel, glossy-glare, and dynamic-motion/disocclusion qualification; interactive source/glare-map retouching; calibrated absolute lens-drive/readback, dashboard flow integration, Apple Metal qualification, and real efficiency qualification.
