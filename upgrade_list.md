...
- Status: In Progress (P0 image-quality moat, researched 2026-07-26)
  ...
  - Regenerated OpenAPI with all five adaptive-session routes and verified formatting, feature-matrix consistency, 371 passing workspace unit/integration tests plus doctests (five declared tests/doctests ignored), and strict workspace Clippy across all targets on macOS.
