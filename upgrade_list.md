...
- Status: In Progress (P0 image-quality moat, researched 2026-07-26)
  ...
  - Remaining: calibration capture/fit workflow, empirical uncertainty coverage, held-out physical-depth/PSF calibration, lens-breathing compensation, aperture-constrained occlusion correction, selective local alignment/overlays, glare separation, and adaptive-planner hardware/manifest integration plus real efficiency qualification.
