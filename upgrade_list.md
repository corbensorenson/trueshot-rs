...
- Status: In Progress (P0 image-quality moat, researched 2026-07-26)
  ...
  - Regenerated OpenAPI with all five adaptive-session routes and revalidated formatting, feature-matrix consistency, 402 passing workspace all-target unit/integration tests plus two passing doctests (five declared tests/doctests ignored), and strict workspace Clippy across all targets on macOS.
