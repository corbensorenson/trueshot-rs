...
- Status: In Progress (P0 image-quality moat, researched 2026-07-26)
  ...
  - Remaining: retained real per-ISO Z9 dark/flat capture and real-sensor posterior qualification; lens shading, defect, dark-current/temperature, physical-depth/pupil/PSF, and lens-breathing calibration; real halo-energy/MTF/mixed-pixel and dynamic-motion/disocclusion qualification; interactive source-map retouching; glare separation; and adaptive-planner hardware/manifest integration plus real efficiency qualification.
