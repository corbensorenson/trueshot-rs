...
impl CalibrationPattern {
    pub fn generate_svg(&self) -> Result<String> {
        match self {
            CalibrationPattern::Checkerboard { rows, cols, square_size_mm } => {
                ...
                writeln!(svg, r#"<svg width="{}mm" height="{}mm" viewBox="0 0 {} {}" xmlns="http://www.w3.org/2000/svg">"#, 
                    total_width, total_height, total_width, total_height)?;
                
                // White background
                writeln!(svg, r#"<rect x="0" y="0" width="{}" height="{}" fill="white" />"#, total_width, total_height)?;
                ...
                // Add text info
                writeln!(svg, r#"<text x="{}" y="{}" font-family="Arial" font-size="5" fill="black">Checkerboard {}x{}, {}mm</text>"#, 
                    margin, total_height - margin / 2.0, rows, cols, square_size_mm)?;
