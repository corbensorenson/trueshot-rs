...
| Processing | Physical PSF-aware focus fusion | In Progress | Native fusion validates lens metadata, fits bounded-memory sub-plane peaks on nonuniform diopter coordinates, applies thin-lens PSF sampling confidence, and exports unquantized meter depth; held-out calibration, lens breathing, aperture-constrained halo suppression, and boundary trimaps remain |
