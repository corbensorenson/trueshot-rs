...
| Processing | Deterministic focus/HDR quality gates | In Progress | Scale-decoupled synthetic baseline is 44.161 dB PSNR and 100% depth accuracy with a 44 dB floor plus radiance/deghost/CFA/visibility/local-motion/disocclusion/source-fallback/glare/trimap invariants; synthetic crossing-halo energy falls from 23.759999 to 0.002434 against the 50% improvement floor, with exact source attribution and tile-invariant pixels/maps. On one Apple M1, the isolated 2048x1536 focus stencil plus robust 3x3 evidence measured 4.83x p50 and 5.48x p95 faster than the prior scalar/sorted implementation with 4.77e-7 maximum absolute error; this is not an end-to-end NEF timing claim. Redistributable real corpus and direct competitor gates remain |
| Processing | Calibrated probabilistic RAW fusion | In Progress | One streamed paired dark/flat pass independently fits exact-ISO Poisson-Gaussian noise and an optics-bound per-CFA spatial gain grid/persistent-defect map. Whole-pair fit/holdout splits, variance/coverage/spatial-p95 gates, probabilistic censor margins, bounded digest-bound profiles, censored likelihood, gain-squared uncertainty propagation, same-CFA pre-interpolation repair, and exact provenance maps are implemented. Identity includes camera, sensor geometry/bit depth, lens, aperture, focal length, and measured focus envelope; mismatches fail closed. Retained real Z9 integrating-sphere and posterior qualification remain |
